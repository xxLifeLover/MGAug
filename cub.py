# This is modified from torchmeta.datasets.CUB
...
class CUBClassDataset(ClassDataset):
    ...
    def download_from_url(self, url, root_path, filename):
        ...
        urllib.request.urlretrieve(url, root_path+"/"+filename, _progress)
    ...
    def download(self):
        ...
        self.download_from_url(self.url, self.root, self.tgz_filename)
